  ...
  return (
    <main className="min-h-screen py-16 bg-gray-50">
      <div className="container mx-auto px-4 max-w-6xl">
        <h1 className="text-4xl font-bold text-gray-900 mb-12 text-center">Enterprise Blog</h1>
                ...
                <article className="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-shadow overflow-hidden flex flex-col h-full border border-gray-100">
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="mt-auto pt-4 border-t border-gray-100">
                      <span className="text-blue-600 font-semibold text-sm">Read article &rarr;</span>
                    </div>
                  </div>
                </article>
              </Link>
